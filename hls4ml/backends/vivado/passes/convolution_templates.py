...
class Conv1DConfigTemplate(LayerConfigTemplate):
    ...
    def format(self, node):
        ...
        # Conv1D: honor mult_strategy the same way Dense does -- substitute in
        # the approximate multiplier class when the user picks a non-standard
        # strategy. Binary/ternary/exponential weight paths are left untouched.
        conv1d_mult_strategy = node.get_attr('mult_strategy', 'standard')
        if conv1d_mult_strategy != 'standard' and mult_params['product_type'] == 'mult':
            mult_params['product_type'] = conv1d_mult_strategy
...
class Conv2DConfigTemplate(LayerConfigTemplate):
    ...
    def format(self, node):
        ...
        # Conv2D: honor mult_strategy the same way Dense does.
        conv2d_mult_strategy = node.get_attr('mult_strategy', 'standard')
        if conv2d_mult_strategy != 'standard' and mult_params['product_type'] == 'mult':
            mult_params['product_type'] = conv2d_mult_strategy
...
class SeparableConv1DConfigTemplate(LayerConfigTemplate):
    ...
    def format(self, node):
        ...
        # SeparableConv1D depthwise: honor mult_strategy.
        sep1d_dw_mult_strategy = node.get_attr('mult_strategy', 'standard')
        if sep1d_dw_mult_strategy != 'standard' and mult_params['product_type'] == 'mult':
            mult_params['product_type'] = sep1d_dw_mult_strategy
        ...
        # SeparableConv1D pointwise: honor mult_strategy.
        sep1d_pw_mult_strategy = node.get_attr('mult_strategy', 'standard')
        if sep1d_pw_mult_strategy != 'standard' and mult_params['product_type'] == 'mult':
            mult_params['product_type'] = sep1d_pw_mult_strategy
...
class SeparableConv2DConfigTemplate(LayerConfigTemplate):
    ...
    def format(self, node):
        ...
        # SeparableConv2D depthwise: honor mult_strategy.
        sep2d_dw_mult_strategy = node.get_attr('mult_strategy', 'standard')
        if sep2d_dw_mult_strategy != 'standard' and mult_params['product_type'] == 'mult':
            mult_params['product_type'] = sep2d_dw_mult_strategy
        ...
        # SeparableConv2D pointwise: honor mult_strategy.
        sep2d_pw_mult_strategy = node.get_attr('mult_strategy', 'standard')
        if sep2d_pw_mult_strategy != 'standard' and mult_params['product_type'] == 'mult':
            mult_params['product_type'] = sep2d_pw_mult_strategy
